...
### The effects of multiple covariates on the detection process in distance sampling models
...
::: g-col-9
#### Stian Sundsvik, MSc thesis

In my master’s thesis, I focus on the detectability of willow ptarmigan (Lagopus lagopus) across Norway with data collected in the period 2009-2020 through the project Hønsefuglportalen where a distance sampling methodology is applied. The detectability is assessed in relation to environmental covariates such as land cover, terrain ruggedness and average temperature, and sampling event covariates such as time of the day, ptarmigan cluster size, number of dogs per transect and daily temperatures. The best fit model will be used to investigate how well it can predict detectability in space and time. Getting a better understanding of the detectability of willow ptarmigan may provide increased accuracy in the population density estimates, which can result in strengthened foundations for decision-makers in the management of the species.
:::
:::
